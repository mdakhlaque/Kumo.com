...
let leftSection = document.querySelector(".shop-left");
...
document
  .querySelector("#menu-login-cancel")
  .addEventListener("click", function () {
...
function validate() {
  ...
  if (username.value == "") {
    document.getElementById("user-eror").innerHTML = "Invalid user";
    flag = 0;
  } else if (username.value.length < 6) {
    document.getElementById("user-eror").innerHTML = "User min 6 char";
    flag = 0;
  } else {
    document.getElementById("user-eror").innerHTML = "";
    document.getElementById("user-success").innerHTML = "Valid";
  }
  ...
  if (email.value == "") {
    ...
    document.getElementById("user-email").innerHTML = "Valid";
  }

  if (password.value == "") {
    document.getElementById("password-eror").innerHTML = "Ivalid Pass";
    flag = 0;
  } else if (password.value.length < 7) {
    document.getElementById("password-eror").innerHTML = "Min 8 Digit";
    flag = 0;
  } else {
    document.getElementById("password-eror").innerHTML = "";
    document.getElementById("pass-error").innerHTML = "Valid";
  }

  if (number.value.length !== 10) {
    document.getElementById("number-eror").innerHTML = "Only 10 Digit";
    flag = 0;
  } else if (number.value.length > 10) {
    document.getElementById("number-eror").innerHTML = "Above 10 Digit";
    flag = 0;
  } else {
    document.getElementById("number-eror").innerHTML = "";
    document.getElementById("num-error").innerHTML = "Valid";
  }
...
document
  .querySelector("#content-right-btn")
  .addEventListener("click", function () {
